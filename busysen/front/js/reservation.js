...
fetch("http://localhost:4202/reservations", requestOptions)
            ...
            for (let j = 0; j < tabReservationsUser[i].reservations.length; j++) {
                ...
                btn.addEventListener('click', () => {
                    ...
                    btn2.addEventListener('click', () => {
                        ...
                        fetch("http://localhost:4202/reservations?room="+tabReservationsUser[i].name+"&id="+tabReservationsUser[i].reservations[j]._id, requestOptions)
